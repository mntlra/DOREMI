...
The Distant Denoised Datasets (DDSs) generated by DOREMI are available in [Zenodo](https://zenodo.org/records/18170553).
...
```bibtex
@article{menotti_etal-2026,
	author = {Laura Menotti and Stefano Marchesin and Gianmaria Silvello},
	doi = {https://doi.org/10.1016/j.knosys.2026.115359},
	issn = {0950-7051},
...
Directory ```repro``` contains the scripts to reproduce the experimental evaluation presented in the paper. We release the scripts to run DREEAM and ATLOP in the DDSs generated by DOREMI.
