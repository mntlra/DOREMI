...
class ContextAware(nn.Module):
	def __init__(self, config, my_logger):
	...
	def forward(self, context_idxs, pos, context_ner, context_char_idxs, context_lens, h_mapping, t_mapping, relation_mask, dis_h_2_t, dis_t_2_h):
		...
		# self.logger.logger.info(f"[ContextAware]  Size of self.dis_embed: {self.dis_embed.size()}")
		# self.logger.logger.info(f"dis_h_2_t: {dis_h_2_t}")
		# self.logger.logger.info(f"dis_t_2_h: {dis_t_2_h}")
		# self.logger.logger.info(f"[ContextAware] Size of self.dis_embed(dis_h_2_t): {self.dis_embed(dis_h_2_t).size()}")

		# self.logger.logger.info(f"[ContextAware]  Size of start_re_output: {start_re_output.size()}")
