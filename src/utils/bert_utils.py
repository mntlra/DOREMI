...
def process_long_input(model, input_ids, attention_mask, start_tokens, end_tokens, logger):
    """
    ...
    if c <= 512:
        ...
        # ATLOP: uses the embeddings of the last layer
